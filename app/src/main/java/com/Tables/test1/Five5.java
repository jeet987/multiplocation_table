   ...
   // private AdView mAdView;
        ...
        */
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent categoryIntent = new Intent(Five5.this, Six6.class);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent categoryIntent = new Intent(Five5.this,HomeActivity2.class);
                startActivity(categoryIntent);
                finish();
                //showRewardedAd();
            }
        ...
        Prev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent categoryIntent = new Intent(Five5.this,Four.class);
                startActivity(categoryIntent);
                finish();
                //showRewardedAd();
            }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent categogyIntent = new Intent(Five5.this, HomeActivity2.class);

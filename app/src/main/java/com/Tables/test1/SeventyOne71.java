    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent categoryIntent = new Intent(SeventyOne71.this, SeventyTwo72.class);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent categoryIntent = new Intent(SeventyOne71.this,HomeActivity2.class);
                startActivity(categoryIntent);
                finish();
               // showRewardedAd();
            }
        ...
        Prev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent categoryIntent = new Intent(SeventyOne71.this,Seventy70.class);
                startActivity(categoryIntent);
                finish();
                //showRewardedAd();
            }
    ...
    */
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent categogyIntent = new Intent(SeventyOne71.this, HomeActivity2.class);
